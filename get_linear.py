...
#Plot the first 20 terms of the albedo array as a function of the BCID both for the old and the updated version of the model
#Performs an interpolation to estimate the fourth entry of the array, in order to reprodce an exponential decrease
...
#Estimate of new Alebdo terms from average over a set of Run-3 fills
...
y = y*100 #transofrmed in percentage (logarithmic scale does not allow the plotting of values smaller than 0.01)
